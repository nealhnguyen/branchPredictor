...
#multiple_data = [diff_values]

for diff_values in dataframes:
    if len(diff_values) <= 1: continue

    addrss = diff_values[0].iloc[0]
    ...
    for i in range(len(test) - 1):
        ...
        print('Address=%s, Predicted=%f, Expected=%f' % (address, yhat, expected))
